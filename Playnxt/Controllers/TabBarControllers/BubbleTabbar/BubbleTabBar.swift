...
open class BubbleTabBar: UITabBar,UITabBarControllerDelegate {
    ...
    private func configure() {
        backgroundColor = #colorLiteral(red: 0.8862745098, green: 0.4196078431, blue: 0.262745098, alpha: 1)
        isTranslucent = false
        barTintColor = #colorLiteral(red: 0.8862745098, green: 0.4196078431, blue: 0.262745098, alpha: 1)
     
       
        tintColor =  #colorLiteral(red: 0.9201369882, green: 0.5902090669, blue: 0.4842595458, alpha: 1)
