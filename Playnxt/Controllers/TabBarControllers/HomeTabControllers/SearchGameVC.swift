...
class SearchGameVC: UIViewController,UITextFieldDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("serachsdnkdso..........",txtSearch)
        if txtSearch?.isEmpty == true {
            print("Empty...........")
        }else {
            apiSearching()
        }
    ...
    func apiSearching(){
        ...
        let param:[String:Any] = ["key":txtSearch ?? "",
                                  "type":searchType ]
...
extension SearchGameVC : UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = dataTableView.dequeueReusableCell(withIdentifier: "cell") as! SearchGameTableCell
...
class SearchGameTableCell : UITableViewCell {
